    ...
    <StudentLayout navigation={navigation}>
      ...
      <View style={styles.messagesContainer}>
        {messages.map((msg, index) => (
          <View
            key={index}
            style={[styles.messageBubble, msg.sender === "me" ? styles.myMessage : styles.otherMessage]}
          >
            <Text style={[ msg.sender === "me" ? [styles.messageText, {color:"white"}] : styles.messageText]}>{msg.text}</Text>
          </View>
        ))}
      </View>
