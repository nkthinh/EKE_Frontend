      ...
      <View style={styles.feedbackContainer}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardDescription}>
            Hãy giúp chúng tôi cải thiện công cụ để phù hợp nhất với nhu cầu của bạn bằng cách đánh giá chúng tôi tại đây!
          </Text>
          <View style={styles.starRating}>
            {[1, 2, 3, 4, 5].map((value) => (
              <TouchableOpacity key={value} onPress={() => handleStarPress(value)} style={styles.starContainer}>
                <Icon
        ...
        <View style={styles.card}>
          ...
          <View style={styles.starRating}>
            {[1, 2, 3, 4, 5].map((value) => (
              <TouchableOpacity key={value} onPress={() => handleSessionStarPress(value)}>
                <View style={[styles.ratingCircle, value <= sessionRating ? styles.selectedRatingCircle : styles.unselectedRatingCircle]}>
                  <Text style={[styles.sessionRatingText, value <= sessionRating ? styles.selectedRatingText : styles.unselectedRatingText]}>
                    {value}
                  </Text>
                </View>
              </TouchableOpacity>
