    ...
    <StudentLayout navigation={navigation}>
      <View style={styles.container}>
        ...
        <View style={styles.toggleContainer}>
          <TouchableOpacity
            style={[styles.toggleTab, activeTab === "Cá nhân" && styles.activeTab]}
            onPress={() => setActiveTab("Cá nhân")}
          >
            <Text style={[styles.toggleText, activeTab === "Cá nhân" && styles.activeText]}>Cá nhân</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.toggleTab, activeTab === "Thông Tin Học Sinh" && styles.activeTab]}
            onPress={() => setActiveTab("Thông Tin Học Sinh")}
          >
            <Text style={[styles.toggleText, activeTab === "Thông Tin Học Sinh" && styles.activeText]}>Thông Tin Học Sinh</Text>
          </TouchableOpacity>
        </View>
        {activeTab === "Cá nhân" ? (
          <>
            ...
            <View style={styles.studentContainer}>
              ...
              <View style={styles.selectContainer}>
                <Picker
                  ...
                  style={styles.picker}
                  onValueChange={(itemValue) => setAcademicPerformance(itemValue)}
                >
